...
# Path untuk dataset
SQL_INJECTION_FILE = Path('C:/laragon/www/capstone/backendd/SQL_Injection.log')
BRUTE_FORCE_FILE = Path('C:/laragon/www/capstone/backendd/brute_force.log')
XSS_FILE = Path('C:/laragon/www/capstone/backendd/XSS.log')
ACCESS_LOG_FILE = Path('C:/laragon/www/capstone/backendd/access.log')
AUTH_LOG_FILE = Path('C:/laragon/www/capstone/backendd/auth.log')  # Menambahkan auth.log sebagai data tes
...
try:
    ...
    # Load dataset training
        ...
        output_file = Path('C:/laragon/www/capstone/backendd/hasil_evaluasi_model.json')
